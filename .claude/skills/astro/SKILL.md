...
- `pnpm astro dev` - Start the development server.
- `pnpm astro build` - Build your project and write it to disk.
- `pnpm astro check` - Check your project for errors.
- `pnpm astro add` - Add an integration.
